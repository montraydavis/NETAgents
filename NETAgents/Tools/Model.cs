...
namespace NETAgents.Tools
{
    ...
    public abstract class Model
    {
        ...
        public abstract Task<LLMMessage> Generate(List<LLMMessage> messages, ModelCompletionOptions? options = null);
        ...
        /// <returns>A chat message containing the model's response</returns>
        public virtual Task<LLMMessage> GenerateAsync(List<LLMMessage> messages, ModelCompletionOptions? options = null,
            ...
            [System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            ...
            LLMMessage result = await GenerateAsync(messages, options, cancellationToken);
        ...
        public virtual LLMMessage ParseToolCalls(LLMMessage message)
        {

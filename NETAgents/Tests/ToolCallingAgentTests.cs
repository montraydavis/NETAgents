...
namespace NETAgents.Tests
{
    public class ToolCallingAgentTests
    {
        ...
        public void ActionStep_ShouldIncludeToolResponsesInMessages()
        {
            ...
            {
                ModelOutputMessage = new LLMMessage(MessageRole.Assistant, "I'll call a tool", "I'll call a tool"),
        ...
        public void ActionStep_ShouldHandleMultipleToolResponses()
        {
            ...
            var actionStep = new ActionStep(1)
            {
                ModelOutputMessage = new LLMMessage(MessageRole.Assistant, "I'll call multiple tools", "I'll call multiple tools"),
        ...
        public void ActionStep_ShouldHandleNoToolResponses()
        {
            ...
            var actionStep = new ActionStep(1)
            {
                ModelOutputMessage = new LLMMessage(MessageRole.Assistant, "No tools needed", "No tools needed"),
                ToolResponses = null
            };

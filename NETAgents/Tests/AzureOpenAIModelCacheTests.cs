...
namespace NETAgents.Tests
{
    public class AzureOpenAIModelCacheTests
    {
        ...
        public void TestCacheKeyGeneration()
        {
            ...
            {
                new LLMMessage(MessageRole.User, "Hello, how are you?")
            };
        ...
        public void TestCacheKeyUniqueness()
        {
            // Arrange
            AzureOpenAIModel model = new AzureOpenAIModel(_testModelId, _testEndpoint, _testApiKey);
            List<LLMMessage> messages1 = new List<LLMMessage>
            {
                new LLMMessage(MessageRole.User, "Hello")
            };
            List<LLMMessage> messages2 = new List<LLMMessage>
            {
                new LLMMessage(MessageRole.User, "Hello there")
            };

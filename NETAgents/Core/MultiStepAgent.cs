    ...
    [System.Runtime.CompilerServices.EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            ...
            {
                LLMMessage finalAnswer = await ProvideFinalAnswerAsync(Task!, images, cancellationToken);
        ...
        protected virtual async Task<PlanningStep> GeneratePlanningStepAsync(string task, bool isFirstStep, int stepNumber, CancellationToken cancellationToken = default)
        {
            ...
            return new PlanningStep("Generated plan", new LLMMessage(MessageRole.Assistant, "Plan generated", "Plan generated"));
        }
        ...
        protected virtual async Task<LLMMessage> ProvideFinalAnswerAsync(string task, List<object>? images = null, CancellationToken cancellationToken = default)
        {
            List<LLMMessage> messages = Memory.ToMessages();
